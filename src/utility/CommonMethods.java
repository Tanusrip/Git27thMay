...
public class CommonMethods {
	...
	public static WebDriver Browsertype(String bname) {
		if (bname.equalsIgnoreCase("CHROME")) {
			...
			Reporter.log("The Browser which got reopened is :" +bname);
			
		} else if(bname.equalsIgnoreCase("FIREFOX")) {
			driver = new FirefoxDriver();
			Log.info("The Browser which  not got reopened is :" +bname);
			Reporter.log("The Browser which  not got reopened is :" +bname);
